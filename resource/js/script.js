...
function sendEmail1() {
    Email.send({
        Host : "smtp.gmail.com",
        Username : "thanhdonghcmute@gmail.com",
        Password : "aqobwiwmnefgezvz",
        To : "thanhdonghcmutrans@gmail.com",
        From : document.getElementById("email").value,
        Subject : "Đặt lịch hẹn",
        Body : "Tên: " + document.getElementById("name").value
            + "<br> Email: " + document.getElementById("email").value
            + "<br> Số điện thoại: " + document.getElementById("phone-number").value
            + "<br> Ngày hẹn: " + document.getElementById("datepicker").value
            + "<br> Loại dịch vụ: " + document.getElementById("current-option").textContent
            // + "<br> Lời nhắn: " + document.getElementById("yourMessage").value
    }).then(
        message =>{
            //console.log (message);
            if(message=='OK'){
            alert('Đã đặt lịch hẹn thành công');
                ...
                alert('Đặt lịch không thành công! Quý khách vui lòng điền đầy đủ thông tin')
...
$('.course-item').on('mouseenter', function () {
    let active = $(this);
    let currentDirec;
    // static variable : fix the direction is constantly changing
    if (typeof currentDirec == 'undefined') {
